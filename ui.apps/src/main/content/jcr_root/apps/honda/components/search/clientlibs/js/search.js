...
$(document).ready(function() {
    ...
    var $searchExpanded = $('#searchExpanded');
    var $searchInput = $('#searchInput');
    var $searchClose = $('#searchClose');
    var $searchMic = $('#searchMic');
    
    /**
     * Opens the search overlay
     */
    function openSearch() {
        $searchTrigger.addClass('hidden');
    ...
    function handleSearch() {
        ...
        if (searchTerm) {
            ...
            window.location.href = `/content/honda/us/en/search.html?q=${encodeURIComponent(searchTerm)}`;
    ...
    function initEventHandlers() {
        ...
        $(document).on('keydown', function(e) {
            if (e.which === 27 && $searchExpanded.hasClass('active')) { // Escape key
                closeSearch();
            }
        });
        
        // Voice search placeholder
        $searchMic.on('click', function() {
        ...
        $(document).on('click', function(e) {
            var $target = $(e.target);
            if (!$target.closest($searchExpanded).length && 
                !$target.closest($searchTrigger).length && 
                $searchExpanded.hasClass('active')) {
                closeSearch();
            }
        });
    }
    ...
    if ($searchTrigger.length && $searchExpanded.length) {
        initEventHandlers();
    }
