...
public class PostLoginRedirectServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        try {
            ...
            if (firstName != null) createCookie(response, "hondaFirstName", firstName);
            if (lastName != null) createCookie(response, "hondaLastName", lastName);
            if (email != null) createCookie(response, "hondaEmail", email);
